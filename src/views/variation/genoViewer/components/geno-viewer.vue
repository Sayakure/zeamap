          ...
          <div class="region-select">
            ...
            <div class="region-select-form">
              <div class="form-radio">
                <el-radio v-model="region" label="2">备选项</el-radio>
                <el-radio v-model="region" label="1">备选项</el-radio>
                <el-radio v-model="region" label="3">备选项</el-radio>
              </div>
              <div class="form-item">
                <div class="chr">
                  <span>chr</span>
